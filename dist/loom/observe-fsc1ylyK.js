import { b as e, f as t, h as n, m as r, p as i, t as a } from "./loom-B6598vHo.js";
...
function V(t, n = "count") {
	...
	let a = !1, s = () => {
		if (!a) {
			a = !0;
			for (let e of i) e.node.meters++, r && (e.node.samples++, P(e.node)), e.cursor = e.node.seq;
		}
	}, c = () => {
		if (a) {
			a = !1;
	...
	return s(), {
		read() {
			...
			for (let t of i) {
				let n = t.node, i = n.seq, a = i - t.cursor, o = 0, s = L;
				if (r && n.cap !== 0 && a > 0) {
