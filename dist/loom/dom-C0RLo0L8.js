...
import { a as p, i as m, l as ee, n as te, o as ne, r as h, s as g, t as _ } from "./ownership-base-D5Jdu92o.js";
//#region src/dom/element-reads.ts
var re = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new Map(), y = null, b = !1;
function ie(e) {
	for (let t of e) {
...
function ae(e) {
	y ??= new MutationObserver(ie), y.observe(e, { attributes: !0 });
}
function oe() {
	b || (b = !0, queueMicrotask(() => {
		...
		let e = y;
		if (e !== null) {
			if (ie(e.takeRecords()), e.disconnect(), v.size === 0) {
				y = null;
				return;
			}
			for (let e of v.keys()) ae(e);
		}
	}));
}
function se(e, t, n) {
	let r = v.get(e);
	r || (r = /* @__PURE__ */ new Map(), v.set(e, r), ae(e)), r.set(t, n);
}
function ce(e, t) {
	let n = v.get(e);
...
function x(e, t) {
	return S(re, e, t, () => ue(e, t));
}
function ue(e, t) {
	return l((n) => (n(e.getAttribute(t)), le(e, t, n)), e.getAttribute(t));
}
function S(e, t, n, r) {
	let i = e.get(t);
...
function Ae(e, t, n) {
	...
	a === -1 && (a = i.indexOf("all"));
	let o = a === -1 ? 0 : ke(r.transitionDuration, a) + ke(r.transitionDelay, a), s = !1, c, l = () => {}, u = () => {
...
function Be(e, t, n = {}) {
	return n.skip !== void 0 && ze(e, n) ? e : e.tagName === t.tagName ? (Ve(e, t), He(e, t), We(e, t, n), e) : (e.replaceWith(t), t);
}
function Ve(e, t) {
	let n = e.attributes;
...
var A = (e, t) => t.key && e.nodeType === 1 ? t.key(e) : null;
function We(e, t, n) {
...
function $e(e, t, n) {
	let r = n?.root ?? null, i = Ye(n), a = Qe(e, t, r, Ze(r), Xe(i), i);
	return h(e, a);
}
//#endregion
...
function I(e, t, n) {
	let r = P.get(e);
	r ? n && (F?.unobserve(e), F?.observe(e, n)) : (r = /* @__PURE__ */ new Set(), P.set(e, r), F ??= new ResizeObserver(et), F.observe(e, n)), r.add(t);
	let i = O(() => {
		let n = P.get(e);
...
function B(e, t = "y") {
	for (let n = z(e, t); n; n = z(n, t)) if (t === "x" ? n.scrollWidth > n.clientWidth : n.scrollHeight > n.clientHeight) return n;
	return null;
}
var V = (e, t, n, r) => {
...
function ut(e, t = {}) {
	let n = t.axis ?? "y", r = typeof t.scroller == "string" ? e.closest(t.scroller) : t.scroller ?? B(e, n);
	if (!r) return !1;
	if (t.ifHidden) {
		let { start: t, end: i, boxStart: a, boxEnd: o } = V(r, e, n, 0);
		if (i > a && t < o) return !0;
	}
	return t.align === "center" ? lt(r, e, t) : ct(r, e, t), !0;
}
//#endregion
...
function ht(e, t, n) {
	...
	a === -1 && (a = 0);
	let o = i[a] !== void 0 && i[a] !== "none" && i[a] !== "", s = r.animationIterationCount.split(",")[a]?.trim(), c = !o || s === "infinite" ? 0 : mt(r.animationDuration, a) + mt(r.animationDelay, a), l = !1, u, d = () => {}, f = () => {
...
function yt(e, t = null, n) {
	let r = _t.has(e), i = r ? document.createElementNS(gt, e) : document.createElement(e);
	return n !== void 0 && (typeof n == "string" ? i.textContent = n : G(i, n)), t && Lt(i, t, !r), i;
}
function bt(e, ...t) {
...
function xt(e, t = null, n) {
	let r = document.createElementNS(gt, e);
	return n !== void 0 && (typeof n == "string" ? r.textContent = n : G(r, n)), t && Lt(r, t, !1), r;
}
function St(e, t) {
...
function Lt(e, t, n) {
	...
	for (let i in t) {
		...
		if (i === "class" || i === "className") {
			...
			} else !r && nn(a) ? q(e, U(a), void 0, !1) : K(e, a);
			r = !0;
			continue;
		}
		if (i === "style") {
		...
		if (i.startsWith("on") && typeof a == "function") {
			e.addEventListener(en(i), a);
			continue;
		}
		if (qt(e, i)) {
			typeof a == "function" ? Xt(e, i, a) : Yt(e, i, a);
			continue;
		}
		if (!(a == null || a === !1 && !Qt(i))) {
...
function K(e, t) {
	...
	if (t) {
		...
		if (an(t)) for (let n in t) Object.hasOwn(t, n) && Gt(e, n, t[n]);
	}
}
function Ht(e, t) {
	let n = t.trim();
...
var Kt = Symbol("form-control-unset");
function qt(e, t) {
...
function Xt(e, t, n) {
	X(e, `dom.prop.${t}`, () => n(), (n) => Yt(e, t, n), Kt);
}
function Y(e, t, n) {
	let r = e.style;
...
function Q(e, t) {
	return Qt(e) && typeof t == "boolean" ? String(t) : t == null || t === !1 ? null : t === !0 ? "" : String(t);
}
function Qt(e) {
...
//#endregion
export { it as A, Le as B, lt as C, ot as D, st as E, $e as F, Oe as G, Ne as H, Ke as I, Ce as J, k as K, j as L, tt as M, I as N, at as O, N as P, ve as Q, Be as R, ut as S, z as T, Me as U, Ie as V, Ae as W, ye as X, xe as Y, be as Z, At as _, wt as a, ft as b, Ot as c, W as d, bt as f, St as g, vt as h, It as i, nt as j, rt as k, jt as l, xt as m, Ct as n, Mt as o, Tt as p, De as q, Ft as r, yt as s, Nt as t, Pt as u, ht as v, ct as w, B as x, pt as y, Re as z };
