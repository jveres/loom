...
// panel chrome, the graph tree, the trace toolbar, and the theme menu.
...
// State markers: a filled dot when the signal drives a DOM element downstream (bound — the hover
