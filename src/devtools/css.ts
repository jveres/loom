// The inspector panel's element id — shared by the JS (getElementById, storage-key prefix) and by
// inspector.css, which scopes every rule under `#loom-inspector` so the
